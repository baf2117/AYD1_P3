...
class LoginController extends Controller
{
  ...
  public function store(Request $request){
    ...
    $tama = count($cantidad);
    if($tama==0){
      $mensaje ="<strong>Warning!</strong>  Errpr en las credenciales ingresadas <a href=\"login\" class=\"alert-link\">Login </a> Desea Registrarse <a href=\"registro\" class=\"alert-link\">Registro </a>";
