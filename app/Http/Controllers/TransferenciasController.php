...
class TransferenciasController extends Controller
{
    ...
    return view('usuario.transferencia',compact('cuentas'));
  ...
  $id = Session::get('sesionid');
     ...
     $sentencia2 = "Insert into transferencias (cuenta_Re, cuenta_En, Monto, Fecha, Tipo, id_usuario, descripcion) VALUES (".$cuenta.", ".$actual.", ".$monto.", SYSDATE(), 'TRANSFERENCIA', ".$id.", NULL);";
