...
class DebitoController extends Controller
{
    ...
    return view('usuario.debito',compact('cuentas'));
  ...
  $id = Session::get('sesionid');
     ...
     $sentencia2 = "Insert into transferencias (cuenta_Re, cuenta_En, Monto, Fecha, Tipo, id_usuario, descripcion) VALUES (".$actual.", ".$cuenta.", ".$monto.", SYSDATE(), 'DEBITO', ".$id.", '".$descripcion."');";
